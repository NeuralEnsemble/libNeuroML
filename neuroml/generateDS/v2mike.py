...
class include_type(GeneratedsSuper):
    subclass = None
    superclass = None
    def __init__(self, href=None, valueOf_=None, mixedclass_=None, content_=None):
        ...
        self.valueOf_ = valueOf_
    def factory(*args_, **kwargs_):
        if include_type.subclass:
            return include_type.subclass(*args_, **kwargs_)
        else:
            return include_type(*args_, **kwargs_)
    factory = staticmethod(factory)
...
class VoltageConcDepBlock(GeneratedsSuper):
    ...
    def exportAttributes(self, outfile, level, already_processed, namespace_='', name_='VoltageConcDepBlock'):
        if self.block_concentration is not None and 'block_concentration' not in already_processed:
            already_processed.append('block_concentration')
        ...
        if self.scaling_conc is not None and 'scaling_conc' not in already_processed:
            already_processed.append('scaling_conc')
        ...
        if self.scaling_volt is not None and 'scaling_volt' not in already_processed:
            already_processed.append('scaling_volt')
...
class SegmentParent(GeneratedsSuper):
    ...
    def exportAttributes(self, outfile, level, already_processed, namespace_='', name_='SegmentParent'):
        if self.fraction_along is not None and 'fraction_along' not in already_processed:
            already_processed.append('fraction_along')
        ...
        if self.segments is not None and 'segments' not in already_processed:
            already_processed.append('segments')
...
class ProximalDetails(GeneratedsSuper):
    ...
    def exportAttributes(self, outfile, level, already_processed, namespace_='', name_='ProximalDetails'):
        if self.translation_start is not None and 'translation_start' not in already_processed:
            already_processed.append('translation_start')
...
class DistalDetails(GeneratedsSuper):
    ...
    def exportAttributes(self, outfile, level, already_processed, namespace_='', name_='DistalDetails'):
        if self.normalization_end is not None and 'normalization_end' not in already_processed:
            already_processed.append('normalization_end')
...
class Include(GeneratedsSuper):
    ...
    def exportAttributes(self, outfile, level, already_processed, namespace_='', name_='Include'):
        if self.segment_groups is not None and 'segment_groups' not in already_processed:
            already_processed.append('segment_groups')
...
class MembraneProperties(GeneratedsSuper):
    ...
    def __init__(self, channel_population=None, channel_density=None, spike_thresh=None, specific_capacitance=None, init_memb_potential=None, reversal_potential=None):
        if channel_population is None:
            self.channel_population = []
        else:
            self.channel_population = channel_population
        ...
        if specific_capacitance is None:
            self.specific_capacitance = []
        else:
            self.specific_capacitance = specific_capacitance
        if init_memb_potential is None:
            self.init_memb_potential = []
        else:
    ...
    factory = staticmethod(factory)
    def get_channelPopulation(self): return self.channel_population
    def set_channelPopulation(self, channel_population): self.channel_population = channel_population
    def add_channelPopulation(self, value): self.channel_population.append(value)
    def insert_channelPopulation(self, index, value): self.channel_population[index] = value
    def get_channelDensity(self): return self.channel_density
    def set_channelDensity(self, channel_density): self.channel_density = channel_density
    def add_channelDensity(self, value): self.channel_density.append(value)
    def insert_channelDensity(self, index, value): self.channel_density[index] = value
    def get_spikeThresh(self): return self.spike_thresh
    def set_spikeThresh(self, spike_thresh): self.spike_thresh = spike_thresh
    def add_spikeThresh(self, value): self.spike_thresh.append(value)
    def insert_spikeThresh(self, index, value): self.spike_thresh[index] = value
    def get_specificCapacitance(self): return self.specific_capacitance
    def set_specificCapacitance(self, specific_capacitance): self.specific_capacitance = specific_capacitance
    def add_specificCapacitance(self, value): self.specific_capacitance.append(value)
    def insert_specificCapacitance(self, index, value): self.specific_capacitance[index] = value
    def get_initMembPotential(self): return self.init_memb_potential
    def set_initMembPotential(self, init_memb_potential): self.init_memb_potential = init_memb_potential
    def add_initMembPotential(self, value): self.init_memb_potential.append(value)
    def insert_initMembPotential(self, index, value): self.init_memb_potential[index] = value
    def get_reversalPotential(self): return self.reversal_potential
    def set_reversalPotential(self, reversal_potential): self.reversal_potential = reversal_potential
    def add_reversalPotential(self, value): self.reversal_potential.append(value)
    def insert_reversalPotential(self, index, value): self.reversal_potential[index] = value
    ...
    def exportLiteralChildren(self, outfile, level, name_):
        showIndent(outfile, level)
        outfile.write('channel_population=[\n')
        level += 1
        for channelPopulation_ in self.channel_population:
            showIndent(outfile, level)
        ...
        outfile.write('],\n')
        showIndent(outfile, level)
        outfile.write('specific_capacitance=[\n')
        level += 1
        for specificCapacitance_ in self.specific_capacitance:
            showIndent(outfile, level)
            outfile.write('model_.ValueAcrossSegOrSegGroup(\n')
        ...
        outfile.write('],\n')
        showIndent(outfile, level)
        outfile.write('init_memb_potential=[\n')
        level += 1
        for initMembPotential_ in self.init_memb_potential:
            showIndent(outfile, level)
            outfile.write('model_.ValueAcrossSegOrSegGroup(\n')
        ...
        outfile.write('],\n')
        showIndent(outfile, level)
        outfile.write('reversal_potential=[\n')
        level += 1
        for reversalPotential_ in self.reversal_potential:
            showIndent(outfile, level)
...
class InhomogeneousValue(GeneratedsSuper):
    ...
    def __init__(self, inhomogeneous_param=None, value=None):
        self.inhomogeneous_param = _cast(None, inhomogeneous_param)
        self.value = _cast(None, value)
        pass
    def factory(*args_, **kwargs_):
    ...
    factory = staticmethod(factory)
    def get_inhomogeneousParam(self): return self.inhomogeneous_param
    def set_inhomogeneousParam(self, inhomogeneous_param): self.inhomogeneous_param = inhomogeneous_param
    def get_value(self): return self.value
    def set_value(self, value): self.value = value
    ...
    def exportAttributes(self, outfile, level, already_processed, namespace_='', name_='InhomogeneousValue'):
        if self.inhomogeneous_param is not None and 'inhomogeneous_param' not in already_processed:
            already_processed.append('inhomogeneous_param')
            outfile.write(' inhomogeneousParam=%s' % (self.gds_format_string(quote_attrib(self.inhomogeneous_param).encode(ExternalEncoding), input_name='inhomogeneousParam'), ))
        if self.value is not None and 'value' not in already_processed:
            already_processed.append('value')
    ...
    def exportLiteralAttributes(self, outfile, level, already_processed, name_):
        if self.inhomogeneous_param is not None and 'inhomogeneous_param' not in already_processed:
            already_processed.append('inhomogeneous_param')
            showIndent(outfile, level)
            outfile.write('inhomogeneous_param = "%s",\n' % (self.inhomogeneous_param,))
        if self.value is not None and 'value' not in already_processed:
            already_processed.append('value')
            showIndent(outfile, level)
            outfile.write('value = "%s",\n' % (self.value,))
    ...
    def buildAttributes(self, node, attrs, already_processed):
        ...
        if value is not None and 'inhomogeneousParam' not in already_processed:
            ...
            self.inhomogeneous_param = value
        value = find_attr_value_('value', node)
        if value is not None and 'value' not in already_processed:
            already_processed.append('value')
            self.value = value
...
class Species(ValueAcrossSegOrSegGroup):
    ...
    def exportAttributes(self, outfile, level, already_processed, namespace_='', name_='Species'):
        ...
        if self.initial_ext_concentration is not None and 'initial_ext_concentration' not in already_processed:
            already_processed.append('initial_ext_concentration')
        ...
        if self.concentration_model is not None and 'concentration_model' not in already_processed:
            already_processed.append('concentration_model')
        ...
        if self.initial_concentration is not None and 'initial_concentration' not in already_processed:
            already_processed.append('initial_concentration')
...
class SpaceStructure(GeneratedsSuper):
    ...
    def exportAttributes(self, outfile, level, already_processed, namespace_='', name_='SpaceStructure'):
        if self.y_spacing is not None and 'y_spacing' not in already_processed:
            already_processed.append('y_spacing')
        ...
        if self.z_start is not None and 'z_start' not in already_processed:
            already_processed.append('z_start')
        ...
        if self.y_start is not None and 'y_start' not in already_processed:
            already_processed.append('y_start')
        ...
        if self.z_spacing is not None and 'z_spacing' not in already_processed:
            already_processed.append('z_spacing')
        ...
        if self.x_start is not None and 'x_start' not in already_processed:
            already_processed.append('x_start')
        ...
        if self.x_spacing is not None and 'x_spacing' not in already_processed:
            already_processed.append('x_spacing')
...
class GridLayout(GeneratedsSuper):
    ...
    def exportAttributes(self, outfile, level, already_processed, namespace_='', name_='GridLayout'):
        if self.z_size is not None and 'z_size' not in already_processed:
            already_processed.append('z_size')
        ...
        if self.y_size is not None and 'y_size' not in already_processed:
            already_processed.append('y_size')
        ...
        if self.x_size is not None and 'x_size' not in already_processed:
            already_processed.append('x_size')
...
class Base(GeneratedsSuper):
    ...
    def exportAttributes(self, outfile, level, already_processed, namespace_='', name_='Base'):
        ...
        if self.neuro_lex_id is not None and 'neuro_lex_id' not in already_processed:
            already_processed.append('neuro_lex_id')
...
class Population(Standalone):
    ...
    def __init__(self, id=None, neuro_lex_id=None, metaid=None, notes=None, annotation=None, cells=None, extracellular_properties=None, component=None, network=None, size=None, layout=None, instances=None):
        super(Population, self).__init__(id, neuro_lex_id, metaid, notes, annotation, )
    ...
    def validate_NmlId(self, value):
        # Validate type NmlId, a restriction on xs:string.
        pass
    def get_extracellularProperties(self): return self.extracellular_properties
    def set_extracellularProperties(self, extracellular_properties): self.extracellular_properties = extracellular_properties
    ...
    def exportAttributes(self, outfile, level, already_processed, namespace_='', name_='Population'):
        ...
        if self.cells is not None and 'cells' not in already_processed:
            already_processed.append('cells')
        ...
        if self.extracellular_properties is not None and 'extracellular_properties' not in already_processed:
            already_processed.append('extracellular_properties')
    ...
    def exportChildren(self, outfile, level, namespace_='', name_='Population', fromsubclass_=False, pretty_print=True):
        ...
        if self.instances is not None:
            self.instances.export(outfile, level, namespace_, name_='instances', pretty_print=pretty_print)
    def hasContent_(self):
        if (
...
class Space(Base):
    ...
    def exportAttributes(self, outfile, level, already_processed, namespace_='', name_='Space'):
        ...
        if self.based_on is not None and 'based_on' not in already_processed:
            already_processed.append('based_on')
...
class Network(Standalone):
    ...
    def __init__(self, id=None, neuro_lex_id=None, metaid=None, notes=None, annotation=None, space=None, region=None, extracellular_properties=None, population=None, cell_set=None, projection=None, synaptic_connection=None, connection=None, explicit_input=None):
        super(Network, self).__init__(id, neuro_lex_id, metaid, notes, annotation, )
        if space is None:
            self.space = []
        else:
            self.space = space
        ...
        if synaptic_connection is None:
            self.synaptic_connection = []
        else:
            self.synaptic_connection = synaptic_connection
        ...
        if explicit_input is None:
            ...
            self.explicit_input = explicit_input
    def factory(*args_, **kwargs_):
        if Network.subclass:
    ...
    def get_extracellularProperties(self): return self.extracellular_properties
    def set_extracellularProperties(self, extracellular_properties): self.extracellular_properties = extracellular_properties
    def add_extracellularProperties(self, value): self.extracellular_properties.append(value)
    def insert_extracellularProperties(self, index, value): self.extracellular_properties[index] = value
    ...
    def get_cellSet(self): return self.cell_set
    def set_cellSet(self, cell_set): self.cell_set = cell_set
    def add_cellSet(self, value): self.cell_set.append(value)
    def insert_cellSet(self, index, value): self.cell_set[index] = value
    ...
    def get_synapticConnection(self): return self.synaptic_connection
    def set_synapticConnection(self, synaptic_connection): self.synaptic_connection = synaptic_connection
    def add_synapticConnection(self, value): self.synaptic_connection.append(value)
    def insert_synapticConnection(self, index, value): self.synaptic_connection[index] = value
    ...
    def get_explicitInput(self): return self.explicit_input
    def set_explicitInput(self, explicit_input): self.explicit_input = explicit_input
    def add_explicitInput(self, value): self.explicit_input.append(value)
    def insert_explicitInput(self, index, value): self.explicit_input[index] = value
    ...
    def exportChildren(self, outfile, level, namespace_='', name_='Network', fromsubclass_=False, pretty_print=True):
        ...
        for synapticConnection_ in self.synaptic_connection:
        ...
        for explicitInput_ in self.explicit_input:
    ...
    def hasContent_(self):
        if (
            ...
            self.cell_set or
            self.projection or
            self.synaptic_connection or
            self.connection or
            self.explicit_input or
    ...
    def exportLiteralChildren(self, outfile, level, name_):
        ...
        outfile.write('],\n')
        showIndent(outfile, level)
        outfile.write('synaptic_connection=[\n')
        level += 1
        for synapticConnection_ in self.synaptic_connection:
            showIndent(outfile, level)
    ...
    def buildChildren(self, child_, node, nodeName_, fromsubclass_=False):
        if nodeName_ == 'space':
            ...
            obj_.build(child_)
            self.synaptic_connection.append(obj_)
            ...
            obj_.build(child_)
            self.explicit_input.append(obj_)
...
class PulseGenerator(Standalone):
    ...
    def __init__(self, id=None, neuro_lex_id=None, metaid=None, notes=None, annotation=None, delay=None, duration=None, amplitude=None):
        super(PulseGenerator, self).__init__(id, neuro_lex_id, metaid, notes, annotation, )
...
class ChannelDensity(Base):
    ...
    factory = staticmethod(factory)
    def get_variableParameter(self): return self.variable_parameter
    def set_variableParameter(self, variable_parameter): self.variable_parameter = variable_parameter
    def add_variableParameter(self, value): self.variable_parameter.append(value)
    def insert_variableParameter(self, index, value): self.variable_parameter[index] = value
    def get_segmentGroup(self): return self.segment_groups
    def set_segmentGroup(self, segment_groups): self.segment_groups = segment_groups
    def validate_NmlId(self, value):
        # Validate type NmlId, a restriction on xs:string.
    ...
    def get_ion(self): return self.ion
    def set_ion(self, ion): self.ion = ion
    def get_ionChannel(self): return self.ion_channel
    def set_ionChannel(self, ion_channel): self.ion_channel = ion_channel
    ...
    def exportAttributes(self, outfile, level, already_processed, namespace_='', name_='ChannelDensity'):
        ...
        if self.ion_channel is not None and 'ion_channel' not in already_processed:
            already_processed.append('ion_channel')
        ...
        if self.cond_density is not None and 'cond_density' not in already_processed:
            already_processed.append('cond_density')
...
class BiophysicalProperties(Standalone):
    ...
    def __init__(self, id=None, neuro_lex_id=None, metaid=None, notes=None, annotation=None, membrane_properties=None, intracellular_properties=None, extracellular_properties=None):
        super(BiophysicalProperties, self).__init__(id, neuro_lex_id, metaid, notes, annotation, )
    ...
    def get_intracellularProperties(self): return self.intracellular_properties
    def set_intracellularProperties(self, intracellular_properties): self.intracellular_properties = intracellular_properties
    def get_extracellularProperties(self): return self.extracellular_properties
    def set_extracellularProperties(self, extracellular_properties): self.extracellular_properties = extracellular_properties
...
class SegmentGroup(Base):
    ...
    def get_subTree(self): return self.sub_tree
    def set_subTree(self, sub_tree): self.sub_tree = sub_tree
    def add_subTree(self, value): self.sub_tree.append(value)
    def insert_subTree(self, index, value): self.sub_tree[index] = value
    def get_inhomogeneousParam(self): return self.inhomogeneous_param
    def set_inhomogeneousParam(self, inhomogeneous_param): self.inhomogeneous_param = inhomogeneous_param
    def add_inhomogeneousParam(self, value): self.inhomogeneous_param.append(value)
    def insert_inhomogeneousParam(self, index, value): self.inhomogeneous_param[index] = value
    ...
    def exportChildren(self, outfile, level, namespace_='', name_='SegmentGroup', fromsubclass_=False, pretty_print=True):
        ...
        for subTree_ in self.sub_tree:
            subTree_.export(outfile, level, namespace_, name_='subTree', pretty_print=pretty_print)
        for inhomogeneousParam_ in self.inhomogeneous_param:
...
class Morphology(Standalone):
    ...
    def __init__(self, id=None, neuro_lex_id=None, metaid=None, notes=None, annotation=None, segments=None, segment_groups=None):
        super(Morphology, self).__init__(id, neuro_lex_id, metaid, notes, annotation, )
        if segments is None:
            self.segments = []
        else:
...
class AbstractCell(Standalone):
    ...
    superclass = Standalone
    def __init__(self, id=None, neuro_lex_id=None, metaid=None, notes=None, annotation=None, extensiontype_=None):
        super(AbstractCell, self).__init__(id, neuro_lex_id, metaid, notes, annotation, extensiontype_, )
        self.extensiontype_ = extensiontype_
    def factory(*args_, **kwargs_):
...
class ConductanceBasedSynapse(Standalone):
    ...
    def __init__(self, id=None, neuro_lex_id=None, metaid=None, notes=None, annotation=None, erev=None, gbase=None, extensiontype_=None):
        super(ConductanceBasedSynapse, self).__init__(id, neuro_lex_id, metaid, notes, annotation, extensiontype_, )
        self.erev = _cast(None, erev)
...
class DecayingPoolConcentrationModel(Standalone):
    ...
    def __init__(self, id=None, neuro_lex_id=None, metaid=None, notes=None, annotation=None, ion=None, shell_thickness=None, resting_conc=None, decay_constant=None, extensiontype_=None):
        super(DecayingPoolConcentrationModel, self).__init__(id, neuro_lex_id, metaid, notes, annotation, extensiontype_, )
        self.ion = _cast(None, ion)
...
class GateHH(Base):
    ...
    def __init__(self, id=None, neuro_lex_id=None, instances=1, type=None, notes=None, q10_settings=None, forward_rate=None, reverse_rate=None, time_course=None, steady_state=None):
        super(GateHH, self).__init__(id, neuro_lex_id, )
    ...
    def validate_gateTypes(self, value):
        ...
        pass
    def export(self, outfile, level, namespace_='', name_='GateHH', namespacedef_='', pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
    ...
    def exportAttributes(self, outfile, level, already_processed, namespace_='', name_='GateHH'):
        ...
        if self.type is not None and 'type' not in already_processed:
            already_processed.append('type')
            outfile.write(' type=%s' % (quote_attrib(self.type), ))
    def exportChildren(self, outfile, level, namespace_='', name_='GateHH', fromsubclass_=False, pretty_print=True):
        super(GateHH, self).exportChildren(outfile, level, namespace_, name_, True, pretty_print=pretty_print)
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
...
class IonChannel(Standalone):
    ...
    def __init__(self, id=None, neuro_lex_id=None, metaid=None, notes=None, annotation=None, conductance=None, type=None, species=None, gate=None, gate_hh=None):
        super(IonChannel, self).__init__(id, neuro_lex_id, metaid, notes, annotation, )
    ...
    def get_gateHH(self): return self.gate_hh
    def set_gateHH(self, gate_hh): self.gate_hh = gate_hh
    def add_gateHH(self, value): self.gate_hh.append(value)
    def insert_gateHH(self, index, value): self.gate_hh[index] = value
    ...
    def exportChildren(self, outfile, level, namespace_='', name_='IonChannel', fromsubclass_=False, pretty_print=True):
        ...
        for gateHH_ in self.gate_hh:
            gateHH_.export(outfile, level, namespace_, name_='gateHH', pretty_print=pretty_print)
    def hasContent_(self):
        if (
            self.gate or
            self.gate_hh or
...
class neuroml(Standalone):
    ...
    def __init__(self, id=None, neuro_lex_id=None, metaid=None, notes=None, annotation=None, include=None, extracellular_properties=None, intracellular_properties=None, morphology=None, ion_channel=None, decaying_pool_concentration_model=None, exp_one_synapse=None, exp_two_synapse=None, nmda_synapse=None, stp_synapse=None, biophysical_properties=None, cells=None, abstract_cell=None, iaf_tau_cell=None, iaf_cell=None, izhikevich_cell=None, ad_ex_ia_f_cell=None, pulse_generator=None, network=None, ComponentType=None):
        ...
        if decaying_pool_concentration_model is None:
            self.decaying_pool_concentration_model = []
        else:
            self.decaying_pool_concentration_model = decaying_pool_concentration_model
        if exp_one_synapse is None:
            self.exp_one_synapse = []
        else:
            self.exp_one_synapse = exp_one_synapse
        if exp_two_synapse is None:
            self.exp_two_synapse = []
        else:
            self.exp_two_synapse = exp_two_synapse
        if nmda_synapse is None:
            self.nmda_synapse = []
        else:
            self.nmda_synapse = nmda_synapse
        if stp_synapse is None:
            self.stp_synapse = []
        else:
            self.stp_synapse = stp_synapse
        ...
        if iaf_tau_cell is None:
            self.iaf_tau_cell = []
        else:
            self.iaf_tau_cell = iaf_tau_cell
        if iaf_cell is None:
            self.iaf_cell = []
        else:
            self.iaf_cell = iaf_cell
        if izhikevich_cell is None:
            self.izhikevich_cell = []
        else:
            self.izhikevich_cell = izhikevich_cell
        if ad_ex_ia_f_cell is None:
            self.ad_ex_ia_f_cell = []
        else:
            self.ad_ex_ia_f_cell = ad_ex_ia_f_cell
    ...
    def get_intracellularProperties(self): return self.intracellular_properties
    def set_intracellularProperties(self, intracellular_properties): self.intracellular_properties = intracellular_properties
    def add_intracellularProperties(self, value): self.intracellular_properties.append(value)
    def insert_intracellularProperties(self, index, value): self.intracellular_properties[index] = value
    ...
    def get_ionChannel(self): return self.ion_channel
    def set_ionChannel(self, ion_channel): self.ion_channel = ion_channel
    def add_ionChannel(self, value): self.ion_channel.append(value)
    def insert_ionChannel(self, index, value): self.ion_channel[index] = value
    def get_decayingPoolConcentrationModel(self): return self.decaying_pool_concentration_model
    def set_decayingPoolConcentrationModel(self, decaying_pool_concentration_model): self.decaying_pool_concentration_model = decaying_pool_concentration_model
    def add_decayingPoolConcentrationModel(self, value): self.decaying_pool_concentration_model.append(value)
    def insert_decayingPoolConcentrationModel(self, index, value): self.decaying_pool_concentration_model[index] = value
    def get_expOneSynapse(self): return self.exp_one_synapse
    def set_expOneSynapse(self, exp_one_synapse): self.exp_one_synapse = exp_one_synapse
    def add_expOneSynapse(self, value): self.exp_one_synapse.append(value)
    def insert_expOneSynapse(self, index, value): self.exp_one_synapse[index] = value
    def get_expTwoSynapse(self): return self.exp_two_synapse
    def set_expTwoSynapse(self, exp_two_synapse): self.exp_two_synapse = exp_two_synapse
    def add_expTwoSynapse(self, value): self.exp_two_synapse.append(value)
    def insert_expTwoSynapse(self, index, value): self.exp_two_synapse[index] = value
    def get_nmdaSynapse(self): return self.nmda_synapse
    def set_nmdaSynapse(self, nmda_synapse): self.nmda_synapse = nmda_synapse
    def add_nmdaSynapse(self, value): self.nmda_synapse.append(value)
    def insert_nmdaSynapse(self, index, value): self.nmda_synapse[index] = value
    def get_stpSynapse(self): return self.stp_synapse
    def set_stpSynapse(self, stp_synapse): self.stp_synapse = stp_synapse
    def add_stpSynapse(self, value): self.stp_synapse.append(value)
    def insert_stpSynapse(self, index, value): self.stp_synapse[index] = value
    ...
    def add_biophysicalProperties(self, value): self.biophysical_properties.append(value)
    def insert_biophysicalProperties(self, index, value): self.biophysical_properties[index] = value
    def get_cell(self): return self.cells
    def set_cell(self, cells): self.cells = cells
    def add_cell(self, value): self.cells.append(value)
    def insert_cell(self, index, value): self.cells[index] = value
    def get_abstractCell(self): return self.abstract_cell
    def set_abstractCell(self, abstract_cell): self.abstract_cell = abstract_cell
    def add_abstractCell(self, value): self.abstract_cell.append(value)
    def insert_abstractCell(self, index, value): self.abstract_cell[index] = value
    def get_iafTauCell(self): return self.iaf_tau_cell
    def set_iafTauCell(self, iaf_tau_cell): self.iaf_tau_cell = iaf_tau_cell
    def add_iafTauCell(self, value): self.iaf_tau_cell.append(value)
    def insert_iafTauCell(self, index, value): self.iaf_tau_cell[index] = value
    def get_iafCell(self): return self.iaf_cell
    def set_iafCell(self, iaf_cell): self.iaf_cell = iaf_cell
    def add_iafCell(self, value): self.iaf_cell.append(value)
    def insert_iafCell(self, index, value): self.iaf_cell[index] = value
    def get_izhikevichCell(self): return self.izhikevich_cell
    def set_izhikevichCell(self, izhikevich_cell): self.izhikevich_cell = izhikevich_cell
    def add_izhikevichCell(self, value): self.izhikevich_cell.append(value)
    def insert_izhikevichCell(self, index, value): self.izhikevich_cell[index] = value
    def get_adExIaFCell(self): return self.ad_ex_ia_f_cell
    def set_adExIaFCell(self, ad_ex_ia_f_cell): self.ad_ex_ia_f_cell = ad_ex_ia_f_cell
    def add_adExIaFCell(self, value): self.ad_ex_ia_f_cell.append(value)
    def insert_adExIaFCell(self, index, value): self.ad_ex_ia_f_cell[index] = value
    def get_pulseGenerator(self): return self.pulse_generator
    def set_pulseGenerator(self, pulse_generator): self.pulse_generator = pulse_generator
    def add_pulseGenerator(self, value): self.pulse_generator.append(value)
    def insert_pulseGenerator(self, index, value): self.pulse_generator[index] = value
    def get_network(self): return self.network
    def set_network(self, network): self.network = network
    ...
    def exportChildren(self, outfile, level, namespace_='', name_='neuroml', fromsubclass_=False, pretty_print=True):
        ...
        for decayingPoolConcentrationModel_ in self.decaying_pool_concentration_model:
    ...
    def hasContent_(self):
        if (
            ...
            self.morphology or
            self.ion_channel or
            self.decaying_pool_concentration_model or
            self.exp_one_synapse or
            self.exp_two_synapse or
            self.nmda_synapse or
            self.stp_synapse or
            self.biophysical_properties or
            self.cells or
            self.abstract_cell or
            self.iaf_tau_cell or
            self.iaf_cell or
            self.izhikevich_cell or
            self.ad_ex_ia_f_cell or
    ...
    def exportLiteralChildren(self, outfile, level, name_):
        ...
        for include_ in self.include:
            showIndent(outfile, level)
            outfile.write('model_.include_type(\n')
        ...
        outfile.write('],\n')
        showIndent(outfile, level)
        outfile.write('decaying_pool_concentration_model=[\n')
        level += 1
        for decayingPoolConcentrationModel_ in self.decaying_pool_concentration_model:
            showIndent(outfile, level)
...
class ConcentrationModel_D(DecayingPoolConcentrationModel):
    ...
    def __init__(self, id=None, neuro_lex_id=None, metaid=None, notes=None, annotation=None, ion=None, shell_thickness=None, resting_conc=None, decay_constant=None, type=None):
        super(ConcentrationModel_D, self).__init__(id, neuro_lex_id, metaid, notes, annotation, ion, shell_thickness, resting_conc, decay_constant, )
        self.type = _cast(None, type)
        pass
    def factory(*args_, **kwargs_):
...
class Cell(AbstractCell):
    ...
    def __init__(self, id=None, neuro_lex_id=None, metaid=None, notes=None, annotation=None, biophysical_properties='1', morphology_attr=None, morphology=None):
        super(Cell, self).__init__(id, neuro_lex_id, metaid, notes, annotation, )
...
class AdExIaFCell(AbstractCell):
    ...
    def __init__(self, id=None, neuro_lex_id=None, metaid=None, notes=None, annotation=None, reset=None, EL=None, C=None, b=None, Idel=None, Idur=None, VT=None, del_t=None, a=None, thresh=None, g_l=None, Iamp=None, tauw=None):
        super(AdExIaFCell, self).__init__(id, neuro_lex_id, metaid, notes, annotation, )
    ...
    def exportAttributes(self, outfile, level, already_processed, namespace_='', name_='AdExIaFCell'):
        ...
        if self.del_t is not None and 'del_t' not in already_processed:
            already_processed.append('del_t')
...
class IzhikevichCell(AbstractCell):
    ...
    def __init__(self, id=None, neuro_lex_id=None, metaid=None, notes=None, annotation=None, a=None, Idel=None, c=None, b=None, d=None, Idur=None, v0=None, thresh=None, Iamp=None):
        super(IzhikevichCell, self).__init__(id, neuro_lex_id, metaid, notes, annotation, )
        self.a = _cast(None, a)
        self.Idel = _cast(None, Idel)
        self.c = _cast(None, c)
        self.b = _cast(None, b)
...
class IaFCell(AbstractCell):
    ...
    def __init__(self, id=None, neuro_lex_id=None, metaid=None, notes=None, annotation=None, reset=None, C=None, thresh=None, leak_conductance=None, leak_reversal=None):
        super(IaFCell, self).__init__(id, neuro_lex_id, metaid, notes, annotation, )
        self.reset = _cast(None, reset)
        self.C = _cast(None, C)
        self.thresh = _cast(None, thresh)
    ...
    def exportAttributes(self, outfile, level, already_processed, namespace_='', name_='IaFCell'):
        ...
        if self.leak_conductance is not None and 'leak_conductance' not in already_processed:
            already_processed.append('leak_conductance')
        ...
        if self.leak_reversal is not None and 'leak_reversal' not in already_processed:
            already_processed.append('leak_reversal')
...
class IaFTauCell(AbstractCell):
    ...
    def __init__(self, id=None, neuro_lex_id=None, metaid=None, notes=None, annotation=None, reset=None, tau=None, thresh=None, leak_reversal=None):
        super(IaFTauCell, self).__init__(id, neuro_lex_id, metaid, notes, annotation, )
        self.reset = _cast(None, reset)
        self.tau = _cast(None, tau)
        self.thresh = _cast(None, thresh)
        self.leak_reversal = _cast(None, leak_reversal)
...
class ExpTwoSynapse(ConductanceBasedSynapse):
    ...
    def __init__(self, id=None, neuro_lex_id=None, metaid=None, notes=None, annotation=None, erev=None, gbase=None, tau_decay=None, tau_rise=None, extensiontype_=None):
        super(ExpTwoSynapse, self).__init__(id, neuro_lex_id, metaid, notes, annotation, erev, gbase, extensiontype_, )
...
class ExpOneSynapse(ConductanceBasedSynapse):
    ...
    def __init__(self, id=None, neuro_lex_id=None, metaid=None, notes=None, annotation=None, erev=None, gbase=None, tau_decay=None):
        super(ExpOneSynapse, self).__init__(id, neuro_lex_id, metaid, notes, annotation, erev, gbase, )
        self.tau_decay = _cast(None, tau_decay)
        pass
    def factory(*args_, **kwargs_):
...
class StpSynapse(ExpTwoSynapse):
    ...
    def __init__(self, id=None, neuro_lex_id=None, metaid=None, notes=None, annotation=None, erev=None, gbase=None, tau_decay=None, tau_rise=None, stp_mechanism=None):
        super(StpSynapse, self).__init__(id, neuro_lex_id, metaid, notes, annotation, erev, gbase, tau_decay, tau_rise, )
...
class NmdaSynapse(ExpTwoSynapse):
    ...
    def __init__(self, id=None, neuro_lex_id=None, metaid=None, notes=None, annotation=None, erev=None, gbase=None, tau_decay=None, tau_rise=None, voltage_conc_dep_block=None):
        super(NmdaSynapse, self).__init__(id, neuro_lex_id, metaid, notes, annotation, erev, gbase, tau_decay, tau_rise, )
...
def parseLiteral(inFileName):
    ...
    # Enable Python to collect the space used by the DOM.
    doc = None
    sys.stdout.write('#from v2mike import *\n\n')
    sys.stdout.write('import v2mike as model_\n\n')
